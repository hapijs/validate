...
describe('hapi integration', () => {
    ...
    it('can apply auth configuration', () => {
        ...
        const fn = () => {
            ...
            internals.apply('auth', auth);
        };

        expect(fn).to.not.throw();
    });

    it('can apply routeBase configuration', () => {
        ...
        const fn = () => {
            ...
            internals.apply('routeBase', routeBase);
        };

        expect(fn).to.not.throw();
    });

    it('can apply server configuration', () => {
        ...
        const fn = () => {
            ...
            internals.apply('server', server);
        };

        expect(fn).to.not.throw();
    });

    it('can apply route configuration', () => {
        ...
        const fn = () => {
            ...
            internals.apply('route', route, route.method, route.path);
        };
...
internals.apply = function (type, options, ...message) {
